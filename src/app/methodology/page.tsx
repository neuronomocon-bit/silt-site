  ...
  return (
    <PageWrap>
      ...
      <Callout title="Normative language note">
        ...
        <ul style={{ paddingLeft: 18, color: "var(--text-muted)", lineHeight: 1.7 }}>
          <li>
      ...
      <ol style={{ color: "var(--text-muted)", lineHeight: 1.75, paddingLeft: 18 }}>
      ...
      <MutedP style={{ fontSize: 14, marginTop: 18 }}>
        ...
        <a href="/status">Status of the Framework</a>.
      </MutedP>
